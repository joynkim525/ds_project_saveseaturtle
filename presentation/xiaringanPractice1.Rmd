...
set.seed(12345)
rffit <- randomForest(플라스틱 ~  종이류 + 유리병류 + 캔류 + 일인가구 + 인구증가율 + 플라스틱산업부가가치 + 비알콜음료업점포수 + 경제성장률 + 과대포장금지법 + 배달량 + 원유수입단가 + 경제활동인구 + 지역내총생산 + 제조업 + 숙박및음식점업 + 농림어업 + 취수시설, data = finaldata2, importance = TRUE)
varImpPlot(rffit, main = "varImpPlot of model")
```
---
class: lineheight
